...
namespace DAL.Migrations
{
    ...
    [Migration("20211202221813_actualizar")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity.Agenda", b =>
                {
                    ...
                    b.Property<string>("OdontologoNoDocumento")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("CodAgenda");

                    b.HasIndex("OdontologoNoDocumento");
            ...
            modelBuilder.Entity("Entity.Agenda", b =>
                {
                    b.HasOne("Entity.Odontologo", "Odontologo")
                        .WithMany()
                        .HasForeignKey("OdontologoNoDocumento");
            ...
            modelBuilder.Entity("Entity.Odontologo", b =>
                {
                    b.HasOne("Entity.Odontologo", null)
                        .WithMany("Agenda")
                        .HasForeignKey("OdontologoNoDocumento");
                });
