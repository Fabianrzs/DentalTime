    ...
    public partial class firtsMigrations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Consultas", x => x.CodConsultaClinica);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NoDocumeto = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pacientes", x => x.NoDocumeto);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CodHistoriaClinica = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FachaHora = table.Column<DateTime>(type: "datetime2", nullable: false),
